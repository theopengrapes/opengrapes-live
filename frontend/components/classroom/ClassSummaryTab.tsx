					...
					<div className="space-y-4">
						...
						<div className="space-y-3">
							{summaryPoints.map((point, index) => {
								...
								if (match) {
									return (
										<div key={index} className="p-3.5 rounded-xl bg-white/[0.02] border border-white/5 flex flex-col items-start gap-2 hover:border-white/10 transition-colors">
											<span className="text-[10px] font-bold text-indigo-400 uppercase tracking-wider bg-indigo-500/10 px-2 py-0.5 rounded-md border border-indigo-500/20 font-sans">
												{match[1]}
											</span>
